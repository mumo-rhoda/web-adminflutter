                            ...
                            children: [
                              ...
                              IconButton(
                                onPressed: ()async{
                                  ...
                                  callAlertDialog("Success!", "Emergency deleted successfully!", context);
                                },
                              ...
                              IconButton(
                                onPressed: () async{
                                  ...
                                  callAlertDialog("Success!", "Emergency closed successfully!", context);
          ...
          return Padding(
            padding: const EdgeInsets.only(left: 550.0),
              child: Dialog(
                ...
                insetPadding: EdgeInsets.symmetric(horizontal: 16),
                backgroundColor: Colors.transparent,
                child: AlertDialogWidget(context: context, title: title, description: description, primaryButtonText: "OK",)
              ),
            );
